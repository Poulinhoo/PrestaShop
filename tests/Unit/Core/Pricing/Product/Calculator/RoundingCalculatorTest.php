...
class RoundingCalculatorTest extends TestCase
{
    ...
    {
        // Default mode: ROUND_HALF_UP, default precision: 0 (integer)
        ...
        $productPrice->setTotalPrice(new TaxablePrice(new DecimalNumber('29.99'), TaxRate::zero()));
        ...
        $this->assertTrue(
            $productPrice->getTotalPrice()->getTaxExcluded()->equals(new DecimalNumber('30'))
        );
        $this->assertTrue(
    ...
    public function testRoundsDownWhenBelow5(): void
    {
        ...
        $productPrice->setTotalPrice(new TaxablePrice(new DecimalNumber('29.49'), TaxRate::zero()));
