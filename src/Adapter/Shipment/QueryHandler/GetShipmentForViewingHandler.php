...
use PrestaShop\PrestaShop\Core\Domain\Shipment\QueryHandler\GetShipmentsForViewingHandlerInterface;
use PrestaShop\PrestaShop\Core\Domain\Shipment\QueryResult\OrderShipment;
use PrestaShopBundle\Entity\Repository\ShipmentRepository;
use Throwable;

#[AsQueryHandler]
class GetShipmentForViewingHandler implements GetShipmentsForViewingHandlerInterface
{
    ...
    public function handle(GetShipmentForViewing $query)
    {
        ...
        try {
            return $this->repository->findOneBy(['id' => $shipmentId]);
        } catch (Throwable $e) {
