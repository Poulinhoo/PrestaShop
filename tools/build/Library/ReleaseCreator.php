...
class ReleaseCreator
{
    ...
    protected $patternsRemoveList = [
        ...
        'themes/hummingbird/assets/cache$',
        'themes/hummingbird/docker$',
        'themes/hummingbird/docs$',
        'themes/hummingbird/plugins$',
        ...
        'themes/hummingbird/\.header\-stamp\-afl3\-license\.txt$',
        'themes/hummingbird/\.header\-stamp\-config\.yml$',
